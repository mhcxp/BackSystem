        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <% if(per!=null&&per.intValue()==0) {%>
                    <div class="row">
                        <div class="col-sm-3">
                            <h2 class="sub-header">管理员列表</h2>
                        </div>
                        <div class="col-sm-9">
                            <form id="myForm" onsubmit="return validateForm()" class="navbar-form navbar-right" action="PMS"  method="post">
                                <input name="name" type="text" class="form-control" placeholder="输入管理员名">
  	...
  	return true;
                    ...
                    <div class="table-responsive col-md-12">
                        <table class="table table-striped">
                            ...
                            <% 
								...
								{
									out.println("<tr>");
									out.println("<td><a href=\"PMGG-"+list.get(i).getUsername()+"\">"+list.get(i).getUsername()+"</a></td>");
									out.println("<td>"+list.get(i).getContact()+"</td>");
									out.println("<td>"+pers[list.get(i).getPer()]+"</td>");
									out.println("</tr>");
								}
							%>
                            </tbody>
                    ...
                    <div class="row">
                        <ul class="pagination pull-right">
                        	...
                        	<%}else{%>
                        	<li><a href="PermissionManage-<%=(cur-1)%>">&laquo;</a></li>
                        	<%} %>
                        	<%
                        		for(int i=1;i<=pageNum;i++)
                        			if(cur==i)
                        				out.println("<li class=\"active\"><a href=\"PermissionManage-"+i+"\">"+i+"</a></li>");
                        			else
                        				out.println("<li><a href=\"PermissionManage-"+i+"\">"+i+"</a></li>");
                        	 %>
                        	 <%if(cur==pageNum) {%>
                        	<li class="disabled"><a href="#">&raquo;</a></li>
                        	<%}else{%>
                        	<li><a href="PermissionManage-<%=(cur+1)%>">&raquo;</a></li>
                        	<%} %>
                        </ul>
                    </div>
                    <% }else{ %>
