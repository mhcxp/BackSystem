        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                	...
                	out.println("<form class=\"col-md-5\" action=\"UserCZTest-"+user+"\" method=\"post\">"); %>
                    	<input style="margin-bottom:10px" type="text" class="form-control" name="money">
                        <input class="my_btn pull-right" type="submit" value="确认">
                    </form>
                </div>
            </div>
        </div>
