        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <% if(per!=null&&(per.intValue()==0||per.intValue()==3)) {%>
                    <div class="section">
                        <div class="container">
                        	<div class="row">
                        		<ul class="nav nav-tabs">
  									<li role="presentation" class="active"><a href="InfoFB_News">新闻发布</a></li>
                            ...
                            <div class="row col-md-8" style="margin-top:20px">
                                <div class="col-md-12">
                                    <form id="myForm" onsubmit="return validateForm()"  action="InfoFB_News_Upload" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
      										<div class="col-sm-2"><label for="txt">新闻内容上传</label></div>
      										<div class="col-sm-5"><input type="file" name="txt"></div>
   										</div>
   										<div class="form-group">
      										<div class="col-sm-2"><label for="photo">新闻图片上传</label></div>
      										<div class="col-sm-5"><input type="file" name="photo"></div>
   										</div>
   										<div class="form-group">
   											<div class="col-sm-2"><label for="photo">新闻种类</label></div>
                                            <div class="col-sm-3">
                                                <select class="form-control" name="newsKind">
                                                	<option value="fin">金融新闻</option>
                                                	<option value="hea">健康新闻</option>
                                                	<option value="eas">生活新闻</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
