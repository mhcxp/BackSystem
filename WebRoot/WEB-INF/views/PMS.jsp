            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <form class="navbar-form navbar-right" action="PMS"  method="post">
                    ...
                    <div class="table-responsive col-md-12">
                        <table class="table table-striped">
                            ...
                            <% 
                                ...
                                if(m==null){
                                	out.println("<h3>未找到该管理员</h3>");
                                }else{
                                	out.println("<tr>");
									out.println("<td><a href=\"PMGG-"+m.getUsername()+"\">"+m.getUsername()+"</a></td>");
									out.println("<td>"+m.getContact()+"</td>");
									out.println("<td>"+pers[m.getPer()]+"</td>");
									out.println("</tr>");
                                }
							%>
                            </tbody>
