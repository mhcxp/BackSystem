        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <% if(per!=null&&(per.intValue()==2||per.intValue()==0)) {%>
                    <div class="row">
                        <div class="col-sm-3">
                            <h2 class="sub-header">订单列表</h2>
                        </div>
                        <div class="col-sm-9">
                            <form id="myForm" onsubmit="return validateForm()" action="OMS" class="navbar-form navbar-right" method="post">
                                <input name="ordId" type="text" class="form-control" placeholder="输入订单号">
  	...
  	return true;
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                             <% 
								...
								{
									out.println("<tr>");
									out.println("<td><a href=\"OMGG-"+list.get(i).getOrdId()+"\">"+list.get(i).getOrdId()+"</a></td>");
									out.println("<td>"+list.get(i).getOrdName()+"</td>");
									out.println("<td>"+list.get(i).getOrdMenId()+"</td>");
									out.println("<td>"+ordKinds[list.get(i).getOrdKind()]+"</td>");
									out.println("<td>"+list.get(i).getOrdPrice()+"</td>");
									out.println("<td>"+ordStates[list.get(i).getOrdState()]+"</td>");
                                    out.println("</tr>");
								}
							%>
                            </tbody>
                    ...
                    <div class="row">
                        <ul class="pagination pull-right">
                        	...
                        	<%}else{%>
                        	<li><a href="OrderManage-<%=(cur-1)%>">&laquo;</a></li>
                        	<%} %>
                        	<%
                        		for(int i=1;i<=pageNum;i++)
                        			if(cur==i)
                        				out.println("<li class=\"active\"><a href=\"OrderManage-"+i+"\">"+i+"</a></li>");
                        			else
                        				out.println("<li><a href=\"OrderManage-"+i+"\">"+i+"</a></li>");
                        	 %>
                        	 <%if(cur==pageNum) {%>
                        	<li class="disabled"><a href="#">&raquo;</a></li>
                        	<%}else{%>
                        	<li><a href="OrderManage-<%=(cur+1)%>">&raquo;</a></li>
                        	<%} %>
                        </ul>
                    </div>
                    <% }else{ %>
