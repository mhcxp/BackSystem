        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <% if(per!=null&&(per.intValue()==4||per.intValue()==0)) {%>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
								...
								{
									out.println("<tr>");
									out.println("<td>"+list.get(i).getContent()+"</td>");
									out.println("<td>"+list.get(i).getUserName()+"</td>");
									out.println("<td>"+list.get(i).getTime()+"</td>");
									out.println("<td>"+list.get(i).getReply()+"</td>");
									out.println("<td><a class=\"btn btn-primary\" href=\"CMGG-"+list.get(i).getId()
									+"\">处理</a></td>");
                                    out.println("</tr>");  
								}
								%>
                    ...
                    <div class="row">
                        <ul class="pagination pull-right">
                        	...
                        	<%}else{%>
                        	<li><a href="CSManage-<%=(cur-1)%>">&laquo;</a></li>
                        	<%} %>
                        	<%
                        		for(int i=1;i<=pageNum;i++)
                        			if(cur==i)
                        				out.println("<li class=\"active\"><a href=\"CSManage-"+i+"\">"+i+"</a></li>");
                        			else
                        				out.println("<li><a href=\"CSManage-"+i+"\">"+i+"</a></li>");
                        	 %>
                        	 <%if(cur==pageNum) {%>
                        	<li class="disabled"><a href="#">&raquo;</a></li>
                        	<%}else{%>
                        	<li><a href="CSManage-<%=(cur+1)%>">&raquo;</a></li>
                        	<%} %>
                        </ul>
                    </div>
                    <% }else{ %>
