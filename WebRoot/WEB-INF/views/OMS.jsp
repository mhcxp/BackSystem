            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <form action="OMS" class="navbar-form navbar-right" method="post">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                             <% 
								...
								if(ord==null){
									out.println("<h3>未找到该订单</h3>");
								}else{
									out.println("<tr>");
									out.println("<td><a href=\"OMGG-"+ord.getOrdId()+"\">"+ord.getOrdId()+"</a></td>");
									out.println("<td>"+ord.getOrdName()+"</td>");
									out.println("<td>"+ord.getOrdMenId()+"</td>");
									out.println("<td>"+ordKinds[ord.getOrdKind()]+"</td>");
									out.println("<td>"+ord.getOrdPrice()+"</td>");
									out.println("<td>"+ordStates[ord.getOrdState()]+"</td>");
                                    out.println("</tr>");
								}
							%>
                            </tbody>
